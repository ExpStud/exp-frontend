...
const Footer: FC = () => {
  return <footer className="bg-footer-purple z-10">
    <div className="flex flex-col justify-between mx-10 sm:flex-row gap-2 md:gap-4 text-custom-purple">
      <div className="flex flex-col mt-20 text-xl font-medium">
        ...
        <Link href="/projects" className="mb-3">Our work</Link>
        <Link href="/services" className="mb-3">What we do</Link>
        <Link href="/about" className="mb-3">About us</Link>
        <Link href="/contact">Contact us</Link>
        <p className="mt-20 mb-10 text-xs font-normal text-copyright-purple">©2024 EXP STUDIO™</p>
      </div>

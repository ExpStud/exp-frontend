...
const ContactForm: FC<Props> = (props: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-20 mr-20 flex flex-col gap-4">
      <div className="flex">
        <input
          type="text"
          id="name"
      ...
      <button
        type="submit"
        className="transition-200 inline-flex items-center justify-between disabled:text-white text-background-black disabled:bg-transparent bg-white 
        text-xl font-medium pl-4 py-1 pr-1.5 rounded-full border border-gray-60 max-w-[215px] cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
        disabled={
          !formData.name ||
          !formData.email ||
          !formData.message ||

...
const LetsWorkLink: FC<Props> = (props: Props) => {
  ...
  return (
    <Link href="/contact">
      <div
        className={`max-w-[1920px] w-full pl-5 md:pl-10 py-20 text-[40px] md:text-5xl lg:text-8xl transition-300 cursor-pointer font-barlow ${
      ...
      >
        <p
          className={`text-sand transition-300 ${

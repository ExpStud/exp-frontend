...
const HeroVideo = () => {
  ...
  return (
    <div
      className="relative w-[300px] md:!w-[700px] xl:!w-[700px] aspect-video md:rounded-3xl outline outline-8 xl:outline-[20px] outline-sand bg-black/70 overflow-hidden"
      onClick={() => {

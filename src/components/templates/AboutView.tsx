  ...
  return (
    <div className="relative w-full h-full items-center justify-center overflow-y-scroll">
      ...
      <div className="container ml-128 p-10 text-5xl font-medium">
        ...
        <p className="text-xl w-1/2 mt-5 font-normal">
      ...
      <div className="container ml-128 p-10 flex">
        ...
        <div className="flex flex-col justify-items-start w-1/2">
          ...
          <p className="text-gray-400">
            Project Manager and Designer: With a decade-long career, Miguel
            brings a wealth of experience to the table. As EXP&apos;s project
            manager and designer, Miguel orchestrates seamless collaborations,
            and development cycles ensuring your vision comes to life with
            precision and creativity.
          </p>

          <p className="mt-5">Experience</p>
          <p className="text-gray-400">
            My Slimes & All in Time (1 year and counting) Project Manager at
            DeGods & y00ts (1 year) Hot Heads (1 year)
          </p>
        </div>
      </div>
      ...
      <div className="container ml-128 p-10 flex">
        <div className="flex flex-col justify-items-end w-1/2">
          ...
          <p className="text-gray-400">
            ...
            SaaS web & mobile engineering to pioneering modern solutions on the
            Solana Blockchain.
          </p>

          <p className="mt-5">Experience</p>
          <p className="text-gray-400">
            Liberty Square (1 year and counting) Lead Developer at DeGods &
            y00ts (1 year)
          </p>
        </div>

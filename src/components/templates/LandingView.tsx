          ...
          <div className="">
            <ul className="list-none p-0">
              <li className="flex items-center border-t-2 border-gray-500 border-dotted p-5">
                <span className="mr-2 text-gray-500 text-5xl">1</span><span className="text-white text-2xl">Design</span>
              </li>
              <li className="flex items-center border-t-2 border-b-2 border-dotted border-gray-500 p-5">
                <span className="mr-2 text-gray-500 text-5xl">2</span> <span className="text-white text-2xl">Development</span>
              </li>
              <li className="flex items-center border-b-2 border-dotted border-gray-500 p-5">
                <span className="mr-2 text-gray-500 text-5xl">3</span> <span className="text-white text-2xl">Minting Tools</span>
              </li>
            </ul>
          </div>
          <div className="">
            <ul className="list-none p-0">
              <li className="flex items-center border-t-2 border-dotted border-gray-500 p-5">
                <span className="mr-2 text-gray-500 text-5xl">4</span> <span className="text-white text-2xl">Discord Management</span>
              </li>
              <li className="flex items-center border-t-2 border-b-2 border-dotted border-gray-500 p-5">
                <span className="mr-2 text-gray-500 text-5xl">5</span> <span className="text-white text-2xl">Tech Support</span>
              </li>
              <li className="flex items-center border-b-2 border-dotted border-gray-500 p-5">
                <span className="mr-2 text-gray-500 text-5xl">6</span> <span className="text-white text-2xl">E-Commerce</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8">
            ...
            {testimonialsData.map((testimonial) => (
              <div
                ...
                className={`py-2 px-4 cursor-pointer ${
                  selectedTestimonial.id === testimonial.id ? 'border-b-2 border-white' : 'border-gray-300'
                }`}
          ...
          <div className="border-b p-4 flex items-center">
            <div className="flex items-center">
              ...
              <img src={selectedTestimonial.image} alt={selectedTestimonial.name} className="w-16 h-16 rounded-full" />

              <div className="ml-4">
                
                <div className="font-semibold">{selectedTestimonial.name}</div>
                <div className="text-gray-500">{selectedTestimonial.company}</div>
            ...
            <div className="ml-8">
              <div className="relative">
                <div className="absolute left-0 top-0 text-4xl text-gray-500">&ldquo;</div>
      ...
      <div className="container ml-128 p-10">
        ...
        <div className="w-1/2 mt-10">
          <p>At EXP, we specialise in building cutting-edge identity systems to help 
            ...
            We’ve worked with some of the Canberra region’s finest builders, 
